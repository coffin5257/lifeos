...
grep -q '^connectors:$' "$ROOT/runtime/.lifeos/manifest.yaml"
grep -q '.lifeos/core.md' "$ROOT/runtime/AGENTS.md"
grep -q '.lifeos/core.md' "$ROOT/runtime/CLAUDE.md"
grep -q '.lifeos/connectors.md' "$ROOT/runtime/AGENTS.md"
grep -q '.lifeos/connectors.md' "$ROOT/runtime/CLAUDE.md"
grep -q 'Do not require, initialize, configure, or recommend Git' "$ROOT/INSTALL.md"
grep -q '## 2. Run connector preflight' "$ROOT/INSTALL.md"
grep -q 'Lark / Feishu' "$ROOT/runtime/.lifeos/connectors.md"
grep -q 'Slack' "$ROOT/runtime/.lifeos/connectors.md"
grep -q 'Figma' "$ROOT/runtime/.lifeos/connectors.md"
grep -q 'Notion' "$ROOT/runtime/.lifeos/connectors.md"
